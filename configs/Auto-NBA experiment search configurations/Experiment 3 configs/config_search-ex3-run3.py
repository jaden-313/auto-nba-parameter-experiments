...
C.dataset = 'cifar10'#cifar 10 dataset used
...
if 'cifar' in C.dataset:
    ...
    C.num_bits_list = [4,6,8] #---Experiment variable
    ...
    C.pretrain_epoch = 0 #only using regular epochs
    ...
    C.nepochs = 25 + C.pretrain_epoch#--25 search epochs
    C.eval_epoch = 1
    ...
    C.lr_decay = 0.97
    # multistep
    C.milestones = [5,10,15,20] #only 25 epochs
    C.gamma = 0.1
    # cosine
    ...
    C.train_portion = 0.05  #--5% of dataset used for training
    ...
    C.alpha_weight = 0.05#experiemnt 3 accuracy vs efficiency
    C.beta_weight = 0.05
