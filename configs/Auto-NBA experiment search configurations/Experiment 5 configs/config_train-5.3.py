...
if 'cifar' in C.dataset:
    ...
    C.num_layer_list = [1, 4, 4, 4, 4, 4, 1]
    C.num_channel_list = [24, 36, 48, 96, 168, 276, 528]
    C.stride_list = [1, 1, 2, 2, 1, 2, 1]
    ...
    C.num_bits_list = [4,6,8]  #---matches search file
    ...
    C.nepochs = 25#--25 training epochs
    ...
    C.lr_decay = 0.97
    # multistep
    C.milestones = [5, 10, 15,20]#--matches epochs
    C.gamma = 0.1
    # cosine
